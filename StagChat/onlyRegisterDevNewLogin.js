...
const stagingSecrete = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7InRlYW0iOiJRQSIsInB1cnBvc2UiOiJ1c2Vycy1sb2FkLXRlc3RpbmcifSwiaWF0IjoxNjY2MDgyMjM3LCJhdWQiOiJbb2JqZWN0IE9iamVjdF0iLCJpc3MiOiI0MzMtZGV2In0.KZS7RJMFd_If6gNEAa-IAsgZEZfj8FK5ZTaZu-C_x0k"
...
const getOTP = new URL(
    "https://staging.sharedservice.api.by433.com/api/auth/get-verification-code?email="
);

const verifyEmail = new URL(
    "https://staging.sharedservice.api.by433.com/api/auth/verify-email"
);
